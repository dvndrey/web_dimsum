...
export async function addVarian(id_produk, nama_varian, harga, stok) {
...
export async function updateVarian(id_varian, nama_varian, harga, stok) {
  const { data, error } = await supabase
    .from("varian")
    .update({ nama_varian, harga, stok })
