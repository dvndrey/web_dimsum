    ...
    <div className="space-y-6 bg-transparent">
      ...
      <div className="">
        <div className="flex justify-between items-center gap-3 w-full">
          <div>
            <p className="text-sm text-gray-500 ml-1">Jumlah Kategori: {categories.length} </p>
          </div>
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            ...
            <Button 
              ...
              className="flex items-center gap-2 bg-[#A65C37] text-white hover:bg-[#7f4629]"
            >
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-[#a96543] text-white border-b border-gray-200">
                  <tr>
                    <th className="px-6 py-4 text-xs font-medium uppercase tracking-wider">
                      Kategori
                    </th>
                    <th className="px-6 py-4 text-xs font-medium uppercase tracking-wider">
                      Aksi
                ...
                <tbody className="divide-y divide-gray-200 text">
